...
class HandGestureRecognition:
    ...
    def build(self):
        ...
        self.base_options = python.BaseOptions(
                                model_asset_path=self._full_hand_model)
        ...
        # self.gesture_options = python.BaseOptions(
        #                         model_asset_path=self._gesture_model)
        # self.options_gesture = vision.GestureRecognizer(
        #                     base_options=self.gesture_options,
        #                     num_hands=1,
        #                     min_hand_detection_confidence=0.7,
        #                     min_hand_presence_confidence=0.7,
        #                     min_tracking_confidence=0.7)
    ...
    def main(self):
        ...
        while cap.isOpened():
            ...
            cv2.rectangle(frame, (margin_x, margin_y),
                          (w - margin_x, h - margin_y), (255, 0, 255), 2)
            ...
            if results.hand_landmarks and results.handedness:
                ...
                for i, hand_landmarks in enumerate(results.hand_landmarks):
                    ...
                    cv2.putText(frame, f"ESTADO: {status_text}", (30, 50),
                    ...
                    screen_x = np.interp(x, [margin_x, w - margin_x],
                                         [0, self.screen_width])
                    screen_y = np.interp(y, [margin_y, h - margin_y],
    ...
    def _get_raised_fingers(self, hand_landmarks, handedness_name):
        """
